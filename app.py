...
# ===============================
model = joblib.load('best_model_rf.pkl')      # Ganti sesuai nama file modelmu
scaler = joblib.load('scaler.pkl')            # Scaler hasil training
...
scc = st.selectbox("Kontrol asupan kalori?", ["Yes", "No"])
...
tue = st.number_input("Waktu menggunakan gadget (jam)", min_value=0.0, max_value=3.0, value=1.0)
